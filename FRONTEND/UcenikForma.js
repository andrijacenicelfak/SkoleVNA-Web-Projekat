...
function kreirajDivTextITextBox(lblText, lblClass, tbxClass, tbxID, divClass) {
...
function kreirajDivButton(btnClass, btnText, divClass, func) {
...
export class UcenikForma {
    ...
    crtajKontrolu(host) {
        ...
        divAktivnost.className = "divKotrola";
